...
==== FCS_COP.1/KeyedHash Cryptographic Operation (Keyed Hash Algorithm)
======
(selected with FCS_IPSEC_EXT.1.4, FCS_SSHC_EXT.1.6, FCS_SSHS_EXT.1.6, FCS_TLSC_EXT, FCS_TLSS_EXT, FCS_DTLSC_EXT, FCS_DTLSS_EXT, for O.COMMS_PROTECTION, O.STRONG_CRYPTO) +
*Hierarchical to:* +
No other components. +
...
*FCS_CKM.5.1* The TSF shall derive cryptographic keys [*intermediate key*] from [selection: _a RNG generated submask as specified in FCS_RBG_EXT.1, a conditioned password submask, imported submask_] in accordance with a specified key derivation algorithm [*the keyed-hash functions specified in FCS_COP.1/KeyedHash*] and specified cryptographic key sizes [*at least of equivalent security strength (in number of bits) to the BEV or the DEK*] that meet the following: [selection: _NIST SP 800-108 [selection: KDF in Counter Mode, KDF in Feedback Mode, KDF in Double-Pipeline Iteration Mode], NIST SP 800-132, ISO/IEC 11770-6:2016 [selection: KPF2, KPF3, KPF4]_].
...
| FCS_CKM.5 | FCS_COP.1/KeyedHash, FCS_CKM.6, [if selected: FCS_RBG_EXT.1] |FCS_COP.1/KeyedHash included, FCS_CKM.6 included, FCS_RBG_EXT.1 included if selected
