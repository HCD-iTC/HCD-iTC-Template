...
| 0.98 | 24 February 2022 | Draft
| 0.99 | 29 July 2022 | Final Public Draft
|===
...
*Testing of the trusted channel mechanism willShort Messages Test - Bit-oriented Mode*
...
Evaluator shall confirm that when an error in the self-test results is induced into the TOE, the TOE no longer enters into operational mode. For example, DRGB self-test is a self-test function.
...
==== FPT_UDU_EXT Extended USER.DOC Unavailability
