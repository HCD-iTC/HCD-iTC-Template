...
| 1.1-bv.2 | 10 October 2023 | HIT issue #5 (assignments), #7 (selections)
...
* *_+++<del>text that has been struck out</del>+++_* indicates text removed, such as in a selection, and should not be included by the ST author.
