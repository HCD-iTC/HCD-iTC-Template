...
[REVIEW]
====
The ND SD contains a section named "Application of this Supporting Document. Should we add a similar section to this SD? 
====
...
[REVIEW]
====
Other SDs do not contain this section. Should we remove this section? 
====
...
As in this SD provide specific or more detailed guidance to evaluate the _type of_ system, however, it is the CEM work units based on which the evaluator shall perform evaluations.
...
[REVIEW]
====
JC - In the HCD-PP, conditionally-mandatory SFRs are grouped based on functional areas (e.g. B.2 PSTN Fax-Network Separation). I've grouped them based on functional areas in this SD as well.   
====
...
[REVIEW]
====
JC - Need to add paragraphs 1104-1111 from HCD-PP
====
...
[REVIEW]
====
JC - Updated the EA for Guidance Documentation below for TD0494. 
====
...
[REVIEW]
====
JC - Updated the EA for Tests below for TD0494. 
====
...
The EAs for this assurance component focus on understanding the interfaces (e.g., application programing interfaces, command line interfaces, graphical user interfaces, network interfaces) described in the AGD documentation, and possibly identified in the TOE Summary Specification (TSS) in response to the SFRs. Specific evaluator actions to be performed against this documentation are identified (where relevant) for each SFR in Section 2 (Evaluation Activities for SFRs), Section 3 (Evaluation Activities for Conditionally Mandatory Requirements), Section 4 (Evaluation Activities for Optional Requirements), Section 5 (Evaluation Activities for Selection-Based Requirements), and in EAs for AGD, ATE and AVA SARs in other parts of Section 6.

[REVIEW]
====
JC - Should the last sentence in the paragraph above also mention EAs for the conditionally-mandatory, optional, and selection-based SFRs claimed by the ST and specified in sections 3, 4, and 5? 
====
...
[REVIEW]
====
JC- Note: The HCD-PP specifies the elemements for ADV_FSP.1 from CC Part 2 wherase the SD address certain CEM work units for ADV_FSP.1. Additionally, the HCD-PP specifies an AA for TSS whereas the SD does not. 
====
...
[REVIEW]
====
JC - Note: The item above seems to be redundant as it is already covered by 6.3.1.3. Evaluation Activity. 
====
...
[REVIEW]
====
JC - Added the following from ND SD. 
====
...
[REVIEW]
====
JC - Added the text below for this SD. 
====
