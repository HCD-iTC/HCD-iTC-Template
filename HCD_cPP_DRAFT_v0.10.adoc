...
Hierarchical to:
	No other components.
Dependencies:
	[<del>FCS_CKM.2 Cryptographic key distribution, or</del>]
...
** ISO/IEC 19772:2009, Subclause 8.4 and 8.5 “CCM”,
** ISO/IEC 19772:2009, Subclause 11.6 and 11.7 “GCM”],
...
** ISO/IEC 10116:2017, Clause 10 “CTR”,
** ISO/IEC 19772:2009, Subclause 8.4 and 8.5 “CCM”,
** ISO/IEC 19772, Subclause 11.6 and 11.7 “GCM”]
...
* ISO/IEC 14888-3 (subclause 6.3), “Digital signatures with appendix - Part 3: Discrete logarithm based mechanisms”
* ISO/IEC 10118-3 (clause 10, 14), “Hash-functions – Part 3: Dedicated hash-functions”

Case: Elliptic Curve Korean Certificate-based Digital Signature Algorithm

* ISO/IEC 14888-3 (subclause 6.7), “Digital signatures with appendix - Part 3: Discrete logarithm based mechanisms”
* FIPS186-4 (Appendix D.1.2, D.1.3), “Digital Signature Standard”
* The TSF shall implement “NIST curves” P-224, P-256, B-233, B-283, K-233, K-283 (as defined in FIPS PUB 186-4, “Digital Signature Standard”)
* ISO/IEC 10118-3 (clause 10, 14), “Hash-functions – Part 3: Dedicated hash-functions”
...
Hierarchical to:
	No other components.
Dependencies:	[
	FDP_ACC.1 Subset access control, [strikeout]or
...
Dependencies: [
	...
	FCS_TLSC_EXT TLS Client Protocol and/or FCS_TLSS_EXT TLS Server Protocol, or
	FCS_SSHC_EXT SSH Client Protocol or FCS_SSHS_EXT SSH Server Protocol, or
	FCS_DTLSC_EXT DTLS Client Protocol and/or FCS_DTLSS_EXT DTLS Server Protocol, or
...
Dependencies: [
	...
	FCS_TLSC_EXT TLS Client Protocol and/or FCS_TLSS_EXT TLS Server Protocol, or
	FCS_SSHC_EXT SSH Client Protocol or FCS_SSHS_EXT SSH Server Protocol, or
	FCS_DTLSC_EXT DTLS Client Protocol and/or FCS_DTLSS_EXT Server DTLS Protocol, or
	FCS_HTTPS_EXT.1 Extended: HTTPS selected ].
....
...
*AES used in [selection: _CBC, GCM, XTS_] mode*
...
* SEED as specified in ISO/IEC 18033-3, [selection: CBC as specified in ISO/IEC 10116, CFB as specified in ISO/IEC 10116, OFB as specified in ISO/IEC 10116, OFB as specified in ISO/IEC 10116, CTR as specified in ISO/IEC 10116, CCM as specified in ISO/IEC 19772, GCM as specified in ISO/IEC 19772],

Case: HIGHT algorithm

* HIGHT as specified in ISO/IEC 18033-3, [selection: CBC as specified in ISO/IEC 10116, CFB as specified in ISO/IEC 10116, OFB as specified in ISO/IEC 10116, CTR as specified in ISO/IEC 10116],

Case: LEA algorithm

* LEA as specified in ISO/IEC 29192-2, [selection: CBC as specified in ISO/IEC 10116, CFB as specified in ISO/IEC 10116, OFB as specified in ISO/IEC 10116, CTR as specified in ISO/IEC 10116, CCM as specified in ISO/IEC 19772, GCM as specified in ISO/IEC 19772]
...
* [ISO/IEC 18033-3(SEED), ISO/IEC 19772],

Case: LEA algorithm

* [ISO/IEC 29192-2(LEA), ISO/IEC 19772]].
...
* SEED used in [selection: CCM, GCM] and cryptographic key size [selection: 128 bits, 256 bits] that meet the following: SEED as specified in ISO/IEC 18033-3, [selection: CCM as specified in ISO/IEC 19772, GCM as specified in ISO/IEC 19772],

Case: LEA algorithm

* LEA used in [selection: CCM, GCM] and cryptographic key size [selection: 128 bits, 256 bits] that meet the following: LEA as specified in ISO/IEC 29192-2, [selection: CCM as specified in ISO/IEC 19772, GCM as specified in ISO/IEC 19772]
...
Hierarchical to:
	No other components.
Dependencies: [
	FCS_TLSC_EXT TLS Client Protocol, and/or
...
Hierarchical to:
	No other components.
Dependencies:
	[<del>FDP_ITC.1 Import of user data without security attributes, or
	FDP_ITC.2 Import of user data with security attributes, or</del>
	FCS_CKM.1/SKG Cryptographic Key Generation (Symmetric Keys)]
	FCS_COP.1/Hash Cryptographic operation (Hash Algorithm),
	FCS_CKM_EXT.4 Extended: Cryptographic Key Material Destruction
...
* ISO/IEC9797-1, Section 7.6 “MAC Algorithm 5”; [selection:
...
* _FFC Schemes using ‘safe-prime’ groups that meet the following: “NIST Special Publication 800-56A Revision 3, Recommendation for Pair-Wise Key Establishment Schemes Using Discrete Logarithm Cryptography” and [selection: RFC 3526, RFC 7919]._
* _KCDSA-based key establishment schemes using key size of [selection: (2048, 224) bit, (2048, 256) bit]: ISO/IEC 14888-3, (Subclause 6.3) “KCDSA”_
* _EC-KCDSA-based key establishment schemes using NIST curve of [selection: P-224, P-256, B-233, B-283, K-233, K-283]: ISO/IEC 14888-3, (Subclause 6.7) “EC-KCDSA”_
