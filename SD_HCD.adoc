= Supporting Document Mandatory Technical Document: Evaluation Activities for collaborative Protection Profile for Hardcopy Devices [DRAFT]
:showtitle:
:doctype: book
:toc: macro
:toclevels: 7
...
:pp-shortname: HCDcPP
:pp-version: 1.0e-DRAFT
:pp-date: 17 January 2024
