= Supporting Document Mandatory Technical Document: Evaluation Activities for collaborative Protection Profile for Hardcopy Devices [DRAFT2]
:showtitle:
:doctype: book
:toc: macro
:toclevels: 7
...
:pp-shortname: HCDcPP
:pp-version: 1.0e-DRAFT2
:pp-date: 29 February 2024
...
| 1.0e-DRAFT2 | 03 March 2024 | DRAFT 2 release 
|===
