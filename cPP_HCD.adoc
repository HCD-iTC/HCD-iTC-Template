...
| 1.1e | 11 September 2026 | Errata version
...
* [#SD]#[SD]# Supporting Document Mandatory Technical Document: Evaluation Activities for collaborative Protection Profile for Hardcopy Devices, v1.1e, 11 September 2026.
...
_For purposes of FTP_ITC.1, an “authorized IT entity” is a trusted IT product, in the sense used by <<CC2>>, that is configured in the evaluated configuration as an authorized endpoint for one or more of the capabilities identified in FTP_ITC.1.1. The trusted communication channel required by this component is the communication channel of <<CC2>> FTP_ITC.1.1, possessing all properties required by that element; the qualifier reflects the terminology used by <<CC2>> for the FTP_ITC family._
