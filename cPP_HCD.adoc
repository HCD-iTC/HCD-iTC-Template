...
:imagesdir: images
:icons: font
:revnumber: 1.1 DRAFT #1.5
:revdate: 10 November 2025
...
| 1.1 DRAFT #1.5 | 10 November 2025 | Prelimary draft 2
...
*Dependencies:* +
    ...
    FCS_CKM.5 Cryptographic key derivation+++<del>, or</del>+++ +
...
[no-bullet]
. 1. For volatile storage, the destruction shall be executed by a [_selection:_
[no-bullet]
...
[no-bullet]
.. a. that consists of an invocation of an interface provided by a part of the TSF, the destruction shall be executed by: [selection:
...
.. b. that employs a wear-leveling algorithm, the destruction shall be executed by a [selection:
[no-bullet]
...
... ii. block erase];
.. c. that does not employ a wear-leveling algorithm, the destruction shall be executed by a [selection:
[no-bullet]
...
| FCS_CKM.6 | FCS_CKM.1 or FCS_CKM_EXT.3 or FCS_CKM.5 or FCS_CKM_EXT.7 or FCS_CKM_EXT.8 | FCS_CKM.1 and FCS_CKM_EXT.3 and FCS_CKM.5 and FCS_CKM_EXT.7 and FCS_CKM_EXT.8 included as selection-based SFRs
