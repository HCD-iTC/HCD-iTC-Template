...
:imagesdir: images
:icons: font
:revnumber: 1.1 DRAFT #2
:revdate: 17 November 2025
...
| 1.1 DRAFT #2 | 17 November 2025 | Draft #2 - CC:2022 update
...
When FCS_COP.1/CMAC is applied to keys used in FPT_SBT_EXT.1, the key-based message authentication key is not CSP, so dependencies on FCS_CKM.1/SKG and FCS_CKM_EXT.6 can be removed.
