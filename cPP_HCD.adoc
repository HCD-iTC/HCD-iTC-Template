...
*FTP_TRP.1.1/Admin Refinement:* The TSF shall *use* [selection, choose at least one of: _IPsec, SSH, TLS, DTLS, TLS/HTTPS_] *to* provide a *trusted* communication path between itself and [remote] [.line-through]#*_users_*# *administrators* that is logically distinct from other communication paths and provides assured identification of its end points and protection of the communicated data from [disclosure *and detection of modification of the communicated data*].

*FTP_TRP.1.2/Admin Refinement:* The TSF shall permit pass:[[]remote [.line-through]#*_users_*# *administrators*] to initiate communication via the trusted path.

*FTP_TRP.1.3/Admin Refinement:* The TSF shall require the use of the trusted path for pass:[[]initial [.line-through]#*_user_*# *administrator* authentication *[and all remote administration actions]*].
...
| FPT_KYP_EXT.1 | FCS_KYC_EXT.1 | FCS_KYC_EXT.1 included as conditionally-mandatory SFR
	...
	FCS_KYC_EXT.1, [if selected: FCS_COP.1/KeyWrap], [if selected: FCS_COP.1/KeyEnc, FCS_COP.1/KeyTransport], [if selected: FCS_SMC_EXT.1 ]
