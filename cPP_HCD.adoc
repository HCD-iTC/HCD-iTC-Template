...
*Dependencies:* +
	pass:[[][.line-through]#+++<del>FDP_ITC.1 Import of user data without security attributes, or</del>+++# +
	[.line-through]#+++<del>FDP_ITC.2 Import of user data with security attributes, or</del>+++# +
...
| FCS_COP.1/KeyEncap | FCS_CKM.1/SKG, FCS_CKM.6 | FCS_CKM.1/SKG included, FCS_CKM.6 included
