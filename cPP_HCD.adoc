...
| 2.0-pre.1 | 8 May 2026 | Working Draft v2.0
...
* KEM-DEM Key-Transport Method that meets the following: [NIST SP 800-227 Section 5.2.1] using a key establishment algorithm [ML-KEM] as specified in FCS_CKM.2 and a key wrapping algorithm as specified in FCS_COP.1/KW]
